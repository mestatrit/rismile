...
public class GWTStringTokenizer {
     ...
     */
    public GWTStringTokenizer(String str, String delim, boolean returnTokens) {
        currentPosition = 0;
        this.str = str;
     ...
     *            the delimiters.
     */
    public GWTStringTokenizer(String str, String delim) {
     ...
     *            a string to be parsed.
     */
    public GWTStringTokenizer(String str) {
        this(str, " \t\n\r\f", false);
    }
