 ...
 * </p>
 */
public abstract class MyDialog extends PopupPanel implements HasHTML, MouseListener, ClickListener{
  ...
  public MyDialog(boolean autoHide, boolean modal) {
	...
	head.getCellFormatter().setHorizontalAlignment(0, 1, HasHorizontalAlignment.ALIGN_RIGHT);
	...
	//head.setCellVerticalAlignment(caption, HasVerticalAlignment.ALIGN_MIDDLE);
	head.setWidget(0, 0, caption);
	head.getCellFormatter().setVerticalAlignment(0, 0, HasVerticalAlignment.ALIGN_BOTTOM);
