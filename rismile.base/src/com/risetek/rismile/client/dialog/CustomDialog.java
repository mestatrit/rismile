...
public class CustomDialog extends DialogBox {
	...
	public CustomDialog() {
		...
		message.getElement().getStyle().setColor("crimson");
		message.getElement().getStyle().setFontSize(12, Unit.PX);
		
		submit.setWidth("120px");
		submit.setHeight("25px");
		submit.getElement().getStyle().setFontWeight(FontWeight.BOLD);

		cancel.setWidth("120px");
		cancel.setHeight("25px");
		cancel.getElement().getStyle().setFontWeight(FontWeight.BOLD);
