...
public class HorizontalTitlePanel extends Composite {
	...
	public HorizontalTitlePanel(String title, boolean isHeader) {
		...
		style.setProperty("borderBottom", "0px");
		style.setProperty("borderLeft", "0px");
		style.setProperty("borderRight", "0px");
		
		if( isHeader )
			style.setProperty("borderTop", "0px");
		else
			style.setProperty("borderTop", "1px solid");
	...
	public HorizontalTitlePanel(String title, boolean isHeader, String height) {
		this(title);
		Style style = getElement().getStyle();
		style.setProperty("borderBottom", "1px solid");
		style.setProperty("borderLeft", "0px");
		style.setProperty("borderRight", "0px");
