...
public class EntryController extends AController {
	...
	private static RequestFactory remoteRequest = new RequestFactory("app/penable");
	...
	class RemoteRequestCallback implements RequestCallback {
		...
		public void onResponseReceived(Request request, Response response) {
			...
			if( XMLDataParse.getElementNumber(text, "OK") > 0 ) { 
				Entry.login = true;
	...
	public class PrivateControl implements ClickHandler, RequestCallback {
		boolean V1 = (null != RuntimeConf.getConfig("DV1"));

		public PrivateDialog dialog = new PrivateDialog();

		@Override
		public void onClick(ClickEvent event) {
			if( !V1 || dialog.isValid())
			{
...
//			String RESTful = password + "/";
			String RESTful = "/" + password;
			remoteRequest.POST(RESTful, null, callback);
	...
	public static void load() {
		...
		remoteRequest.POST(null, null, RemoteCaller);
	}
