...
public class PosEventStack extends PosStack {
    ...
    public void nextEvent() {
        ...
        try {
        	...
        	GWT.log("Failed in nextEvent ()", pe);
        }
    }
...
//                        event = (PosEvent) javaos.javax.system.services.Loader.getInstance(dialogEvent.eventClass());
                    	...
                    	GWT.log("Class not found : " + dialogEvent.eventClass());
                        return;
                    } catch (java.lang.Exception e) {
                    	GWT.log("Class load error : " + e.toString() + "/" + dialogEvent.eventClass(), e);
                        return;
                    }
            ...
            GWT.log("Dialog not found " + dialog_name);
        }
    */
    }
