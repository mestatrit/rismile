...
public class RadiusConfController extends AController {
	...
	private static RequestFactory remoteRequest = new RequestFactory("radius/config");
	...
	public static void modify(String path, RequestCallback callback){
		remoteRequest.POST("/" + path, null, callback);
	}
