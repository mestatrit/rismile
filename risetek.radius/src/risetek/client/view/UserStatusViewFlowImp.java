...
public class UserStatusViewFlowImp extends RismileTableView  implements IRisetekView {
	...
	private final Button RefreshFlow = new Button("重置计量(F)", new RadiusUserStatusController.FlowAction());
